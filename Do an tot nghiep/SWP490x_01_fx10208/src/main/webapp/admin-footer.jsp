<div class="footer mt-1 pt-5">
	<div class="footer-inner">
		<div class="footer-content">
			<span class="bigger-120"> <span class="blue bolder">Donation
					Fund</span> &copy; 2021
...
<script
	src="${pageContext.request.contextPath}/assets/js/dataTables.tableTools.min.js"></script>
<script
	src="${pageContext.request.contextPath}/assets/js/dataTables.colVis.min.js"></script>
<script src="${pageContext.request.contextPath}/assets/js/pagecommon.js"></script>
<script
...
<script type="text/javascript">
		 ...
		 CKFinder.setupCKEditor(editor1,'${pageContext.request.contextPath}/assets/ckfinder');
	jQuery(function($) {
