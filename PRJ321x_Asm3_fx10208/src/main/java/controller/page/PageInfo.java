...
public class PageInfo {
	...
	static {
		...
		pageRoute.put(PageType.CART_PAGE, new PageInfo("Cart Detail", "cart.jsp", null));
		pageRoute.put(PageType.SIGN_UP, new PageInfo("Dang ky", "signup.jsp", null));
		pageRoute.put(PageType.HEADER, new PageInfo("Dau trang", "header.jsp", null));
		pageRoute.put(PageType.FOOTER, new PageInfo("Cuoi trang", "footer.jsp", null));
	}
